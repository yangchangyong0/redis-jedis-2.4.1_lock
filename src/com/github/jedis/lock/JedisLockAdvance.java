 ...
 * @author ycy qq:48599355
 */
public class JedisLockAdvance {
     ...
     */
    public JedisLockAdvance(Jedis jedis, String lockKey) {
        this.jedis = jedis;
     ...
     */
    public JedisLockAdvance(Jedis jedis, String lockKey, int timeoutMsecs) {
        this(jedis, lockKey);
     ...
     */
    public JedisLockAdvance(Jedis jedis, String lockKey, int timeoutMsecs, int expireMsecs) {
     ...
     * @param lockKey lock key (ex. account:1, ...)
     */
    public JedisLockAdvance(String lockKey) {
        this(null, lockKey);
    }
     ...
     * @param timeoutMsecs acquire timeout in miliseconds (default: 10000 msecs)
     */
    public JedisLockAdvance(String lockKey, int timeoutMsecs) {
     ...
     * @param expireMsecs  lock expiration in miliseconds (default: 60000 msecs)
     */
    public JedisLockAdvance(String lockKey, int timeoutMsecs, int expireMsecs) {
